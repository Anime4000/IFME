...
wget http://sourceforge.net/projects/ifme/files/plugins/linux/64bit/mp4fpsmod.ifx -O linux/64bit/plugins/mp4fpsmod.ifx
wget http://sourceforge.net/projects/ifme/files/plugins/linux/64bit/x265gcc.ifx -O linux/64bit/plugins/x265gcc.ifx
echo "Unpacking"
