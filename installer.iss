...
Source: "..\prerequisite\64bit\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs; Check: Is64BitInstallMode
Source: "..\prerequisite\32bit\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs; Check: not Is64BitInstallMode
